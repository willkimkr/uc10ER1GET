...
let listaNoticias = [
    {
        titulo: "Samsung do Brazil cria a primeira bateria movida a energia sonora",
        descricao: "Apos anos de estudos em parceria com Samsung e a UFAM cientistas desenvolveram uma bateria que carrega a bateria por "
    },
    {
...
function renderizarNoticias() {
    ...
    for (let index = 0; index < listaNoticias.length; index++) {
        ...
        <img src="img/cadsnews.svg" alt="foto gameover de noticias">
